...
#include "../../components/crc32/crc32.h"
...
TEST_CASE("test crc32 self", "[crc32]")
{
 ...
 */
TEST_CASE("test crc32 init", "[crc32]")
{
 ...
 */
TEST_CASE("test crc32 empty", "[crc32]")
{
    uint32_t crc = crc32_init(0xFFFFFFFFU);
 ...
 */
TEST_CASE("test crc32 null pointer", "[crc32]")
{
    uint32_t crc = crc32_init(0xFFFFFFFFU);
 ...
 */
TEST_CASE("test crc32 single byte", "[crc32]")
{
 ...
 */
TEST_CASE("test crc32 incremental", "[crc32]")
{
    const char *test_string = "123456789";
 ...
 */
TEST_CASE("test crc32 patterns", "[crc32]")
{
    /* All zeros */
