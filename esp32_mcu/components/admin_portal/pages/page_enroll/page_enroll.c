...
extern const uint8_t _binary_assets_page_enroll_html_start[];
extern const uint8_t _binary_assets_page_enroll_html_end[];
                             ...
                             admin_focus_t focus)
{
    ...
    return admin_page_send_template(req,
                                    _binary_assets_page_enroll_html_start,
                                    _binary_assets_page_enroll_html_end,
                                    pairs,
